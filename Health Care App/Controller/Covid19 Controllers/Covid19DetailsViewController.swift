...
class Covid19DetailsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        newDeaths.text = "new\(stateDetails?.deltadeaths ?? "")"
        newConfirmedCases.text = "new\(stateDetails?.deltaconfirmed ?? "")"
        newRecoveredCases.text = "new\(stateDetails?.deltarecovered ?? "")"
